                ...
                <form id="filter">
                    <div class="row">
                        ...
                        <div class="offset-2 col-2">
                            ...
                            <input class="form-control datetimepicker" type="text" name="startTime" id="startTime">
                        </div>
                        <div class="col-2">
                            <label for="endTime"><spring:message code="meal.endTime"/></label>
                            <input class="form-control datetimepicker" type="text" name="endTime" id="endTime">
                        </div>
                    </div>
                </form>
            </div>
